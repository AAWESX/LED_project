...
void LCD_Draw_ALLCircle(uint16_t x0,uint16_t y0,uint8_t r);                                 //画实心圆
void LCD_DrawLine(uint16_t x1, uint16_t y1, uint16_t x2, uint16_t y2);                          //画线
void LCD_HoriDashed(uint16_t x ,uint16_t y1, uint16_t y2);                                 //画横虚线
void LCD_ArrangedHoriDashed(uint16_t y1, uint16_t y2 ,uint16_t x1, uint16_t x2);                //画横虚线排列
void LCD_Dashed(uint16_t x ,uint16_t y1, uint16_t y2);                                     //画纵虚线
void LCD_ArrangedDashed(uint16_t x1 , uint16_t x2 ,uint16_t y1, uint16_t y2);                   //画纵虚线排列
void LCD_CrossShape(uint16_t x1, uint16_t x2 ,uint16_t y1 ,uint16_t y2);                        //画十字型  
